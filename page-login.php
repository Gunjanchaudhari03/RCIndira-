<?php
	...
	if($_SERVER["REQUEST_METHOD"] == "POST")
  {
      ...
      else
      {
        ...
        $sql= "SELECT * from blogin where  username='".$username."' AND pwd='".$password."' limit 1";
        ...
        if($count==1)
        {
            $_SESSION['user']=$fetch['user'];
			      header('location:focus-main/theme/home.php');
            ...
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    <div class="login-content">
                        ...
                        <h2><center><i>BOD Login</i></center></h2><hr>
                            <form action="page-login.php" method="POST">
                              ...
                              <center>  <button type="submit" class="btn btn-primary btn-flat m-b-30 m-t-30">Login</button><center>
                            </form>
                        </div>
                    </div>
                </div>

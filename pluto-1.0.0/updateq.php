<?php
   ...
   if(isset($_POST['submit']))
   {
      ...
      echo $query="UPDATE queries SET nme='$ufname',email='$mail',question='$email' WHERE ID=$idupdate";
                  ...
                  <div class="login_form">
                        ...
                        <div class="field">
                           ...
                           <div class="field">
                              ...
                              <input name="nme" type="text" id="nme" class=" border-primary user-input-box" value="<?php echo $fname;?>" /><br>
                           </div>
                          
                           <div class="field">
                              <label class="label_field">EmailID</label>
                              <input name="email" type="number" id="email" class="border-primary user-input-box" value="<?php echo $edit_mob;?>" required="" /><br>
                           </div>
                
                           <div class="field">
                              <label class="label_field">Question</label>
                              <input name="question" type="number" id="question" class=" border-primary user-input-box" value="<?php echo $edit_emob;?>" required="" /><br>
                           </div>

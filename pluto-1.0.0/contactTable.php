      ...
      <div class="full_container">
         <div class="inner_container">
            ...
            <div id="content">
               ...
               <h3><u>Contact us Table:-</u></h3><br><br>
   <div class="col-sm-8">
    <?php echo $deleteMsg??''; ?>
    ...
    <center> <table class="table table-bordered">
       <thead><tr><th>S.N</th>
         ...
         <th>Subject</th>
         <th>Message</th>
         <th colspan="" align="center"><b>Operation</b></th>
    </thead>
    <tbody>
  ...
  <?php
    ...
    ?>
     ...
     <tr>
      ...
      <td><a href="deletec.php?id=<?php echo $data['id']; ?>" class="btn btn-primary btn-min-width mr-1 mb-1">delete</td> 
     </tr>
     <?php
      $sn++;}}else{ ?>
      <tr>
    ...
    <td><a href="excel/contact_excel.php" class="btn btn-primary btn-min-width mr-1 mb-1" >Save As Excel</td>
    <td><a href="pdf/contact_pdf.php" class="btn btn-primary btn-min-width mr-1 mb-1" >Save As PDF</td>
     </table></center>
   </div>

...
<br>
               <center> <h3>Feedback Table:-</h3></center>
   <div class="col-sm-8">
    <?php echo $deleteMsg??''; ?>
    <div class="table-responsive">
    <center> <table class="table table-bordered"><br>
       <thead><tr><th>S.N</th>
  ...
  <?php
    ...
    ?>
     ...
     <tr>
      ...
      <td><a href="deletef.php?id=<?php echo $data['id']; ?>" class="btn btn-primary btn-min-width mr-1 mb-1">delete</td> 
     </tr>
     <?php
      $sn++;}}else{ ?>
      <tr>

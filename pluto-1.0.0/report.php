...
$db= $conn;
$tableName="upload";
$columns= ['id', 'name','post','month', 'eve','nme','upload'];
      ...
      <div class="full_container">
         <div class="inner_container">
            ...
            <div id="content">
                        ...
                        <div class="right_topbar">
                           <div class="icon_info">
                              ...
                              <ul class="user_profile_dd">
                                 <li>
                                    <a class="dropdown-toggle" data-toggle="dropdown"><img class="img-responsive rounded-circle" src="images/logo.png" alt="#" /><span class="name_user"></span></a>
               ...
               <h3><u>pre monthly reports:-</u></h3><br><br>
   <div class="col-sm-8">
    <?php echo $deleteMsg??''; ?>
  ...
  <?php
    ...
    ?>
     ...
     <tr>
      ...
      <td><a href="deletereport.php?id=<?php echo $data['id']; ?>" class="btn btn-primary btn-min-width mr-1 mb-1">Delete</td> 
    ...
    <td><a href="excel/feedback_excel.php" class="btn btn-primary btn-min-width mr-1 mb-1" >Save As Excel</td>
    <td><a href="pdf/feedback_pdf.php" class="btn btn-primary btn-min-width mr-1 mb-1" >Save As PDF</td>
     </table></center>
   </div>
</div>
</div>

      ...
      <div class="full_container">
         <div class="inner_container">
            ...
            <div id="content">
             ...
             <br>
            <div class="left verticle_center">
                     ...
                     <form action="dateallocation.php" method="POST">
                        <fieldset>
                           ...
                           <div class="field">
                              ...
                              <input type="submit"  name="submit" class="btn btn-primary btn-min-width mr-1 mb-1" />
                           </div>
              ...
              <div class="right verticle_center">
              <?php
...
function fetch_data($db, $tableName, $columns){
  ...
  <?php
    ...
    <?php
     ...
     <div>
      <center><input type="submit" name="update" value="Update" id="update" class="btn btn-primary btn-min-width mr-1 mb-1"/></center> 
      </div>
      </div>

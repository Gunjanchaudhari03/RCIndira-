            ...
            <nav id="sidebar">
               ...
               <div class="sidebar_blog_2">
                  ...
                  <ul class="list-unstyled components">
                     <li class="active">
                        <a href="dashboard.php" data-toggle="collapse" aria-expanded="false"><i class="fa fa-dashboard yellow_color"></i> <span>Dashboard</span></a>
                     ...
                     <li>
                        ...
                        <ul class="collapse list-unstyled" id="element">
                           ...
                           <li><a href="../../constra-1.0.0/focus-main/theme/table-jsgrid.html"><i class="fa fa-map purple_color2"></i> <span>MOM</span></a></li>
                           <li><a href="charts.html"><i class="fa fa-bar-chart-o green_color"></i> <span>Charts</span></a></li>
                           <li><a href="settings.html"><i class="fa fa-cog yellow_color"></i> <span>Setting</span></a></li>
                        </ul>
                     </li>
                        ...
                        <div class="right_topbar">
                           <div class="icon_info">
                              ...
                              <ul class="user_profile_dd">
                                 <li>
                                    <a class="dropdown-toggle" data-toggle="dropdown"><img class="img-responsive rounded-circle" src="images/logo.png" alt="#" /><span class="name_user">Admin</span></a>
                     ...
                     <div class="row column1">
                        ...
                        <div class="col-md-6 col-lg-3">
                           <div class="full counter_section margin_bottom_30">
                              <div class="couter_icon">
                                 <div> 
                                    <i class="fa fa-diamond red_color"></i>
                                 </div>
                              </div>
                              <div class="counter_no">
                                 <div>
                                    <p class="total_no">13k</p>
                                    <p class="head_couter">People Visited to the site</p>
                                 </div>
                              </div>
                           </div>
                        </div>
                        <div class="col-md-6 col-lg-3">
                           <div class="full counter_section margin_bottom_30">
                              <div class="couter_icon">
                                 <div> 
                                    <i class="fa fa-instagram green_color"></i>
                                 </div>
                              </div>
                              <div class="counter_no">
                                 <div>
                        ...
                        <div class="col-md-6 col-lg-3">
                           <div class="full counter_section margin_bottom_30">
                              <div class="couter_icon">
                                 <div> 
                                    <i class="fa fa-youtube red_color"></i>
                                 </div>
                              </div>
                              <div class="counter_no">
                                   ...
                                   <!-- <p class="total_no">100</p>
                                    <p class="head_couter">Youtube Subscriber</p>-->
                                 </div>
                           </div>
                                          ...
                                          <div id="testimonial_slider" class="carousel slide" data-ride="carousel">
                                             ...
                                             <div class="carousel-inner">
                                                <div class="item carousel-item active">
                                                   <div class="img-box"><img src="../images/BOD/aditya.jpeg" alt=""></div>
                                                   <p class="testimonial">I have a very good experience joining the club. I enthusiastically participate in various club events. And I'm having a great experience. The club is serving the society by carrying out charitable activities and also organizing various interesting events for the members.</p>

                                                   <p class="overview"><b>Rtr Aditya Karad</b></p>
                                                </div>
                                                <div class="item carousel-item">
                                                   
                                                   <p class="testimonial">The member in this club is very kind and active
                                                      I had a good experience while working with each and every mem and will have it ahead too
                                                      Each and every event does have a message behind it 😊</p>
                                                   <p class="overview"><b>Diksha Gaikwad</b></p>
                                                </div>
